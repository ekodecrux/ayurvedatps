-- TPS Dhanvantari Ayurveda - Complete Database Schema
...
-- Sample Patients
INSERT OR IGNORE INTO patients (name, email, phone, gender, age, country, created_at) VALUES
...
-- Sample Appointments
INSERT OR IGNORE INTO appointments (patient_id, appointment_date, appointment_type, status, reason) VALUES
...
INSERT OR IGNORE INTO herbs_routes (patient_id, appointment_id, prescription_date, diagnosis, herbs_medicines, dosage, duration, instructions) VALUES
...
-- Sample Reminders
INSERT OR IGNORE INTO reminders (patient_id, prescription_id, reminder_type, reminder_date, message, status) VALUES
